		...
		chart: {
			events: {
				load: function (e) {
					...
					var legendLeft = 765;
					var legendTop = 270+40;

					fn.addLegendSquare(chart, legendLeft, legendTop, 10, "#B00000");
					fn.addLegendSquare(chart, legendLeft, legendTop + 20, 10, "blue");
					fn.addLegendText(chart, legendLeft + 20, legendTop + 10, 'Schweiz');
					fn.addLegendText(chart, legendLeft + 20, legendTop + 30, 'Ausland');
					fn.addLegendTextbold(chart, 540, 270, 'Anzahl Zugezogene <br> pro 100 Einwohner');
					fn.addLegendTextbold(chart, 765, 270, 'Anteil Zugezogene <br> nach Zuzugsland');
				}
			}
		}
	};
