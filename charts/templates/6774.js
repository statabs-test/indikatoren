		...
		chart: {
			events: {
                ...
                //	var legendLeft = 520;;
					...
					fn.addLegendText(chart,        legendLeft+25, legendTop+32.5,  'Schweiz');
					fn.addLegendSquare(chart,      legendLeft+0,  legendTop+38,  10, "blue");
					fn.addLegendText(chart,        legendLeft+25, legendTop+45.5,  'Ausland');
