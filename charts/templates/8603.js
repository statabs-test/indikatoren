		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace(" ", "<br/>").replace(" ", "<br/>"), 245 + shiftHoriz, 230 + shiftVert);
					
					fn.addLegendTitle(chart,  pieSizeSeries.name.replace(" ", "<br/>"), 385 + shiftHoriz, 230 + shiftVert);
