		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name +" in m²", 540, 270, 'pieLegend');
					...
					fn.addLegendSquare(chart, 773, 405, 10, '#7F5F1A');
					fn.addLegendLabel(chart, 'Zunahme', 788, 398);
					fn.addLegendSquare(chart, 773, 425, 10, '#FABD24');
					fn.addLegendLabel(chart, 'Abnahme', 788, 418);
