		...
		chart: {
			events: {
	            load: function (e) {
					...
					var pieSeriesConfig = function(data, correspondingMapSeriesItem, color){
						return {
	                        ...
	                        tooltip: {
	                            ...
	                            pointFormatter: function () {
	                            	return correspondingMapSeriesItem.roperties.LIBGEO +': <b>' + Highcharts.numberFormat((this.v),2) + '% </b><br/>';
	                            }
	                        },
	                    };
					};
	                ...
	                fn.addLegendTitle(chart,"Staatsangehörigkeit", 240, 215);
					...
					fn.addLegendLabelbold(chart, 'Ausländeranteil in %', 240, 307);
