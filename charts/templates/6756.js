    ...
    tooltip: {
      ...
      formatter: function () {
        ...
        if ((this.point.name == 'Altersquotient') || (this.point.name == 'Jugendquotient')) {
          w = Highcharts.numberFormat((this.point.Wert * 100), 1) + ' </b>Rang';
        }
        else if (this.point.name == 'Baujahr&nbsp;Wohngebäude') {
          w = Highcharts.numberFormat((this.point.Wert), 0, '.', '') + ' </b>Rang';
        }
        else if ((this.point.name == 'Fläche&nbsp;pro&nbsp;Wohnung') || (this.point.name == 'Wohnfläche&nbsp;pro&nbsp;Kopf')) {
          w = Highcharts.numberFormat((this.point.Wert), 1) + ' m² </b>Rang';
        }
        else if ((this.point.name == 'Vermögenssteuer') || (this.point.name == 'Einkommenssteuer')) {
          w = Highcharts.numberFormat((this.point.Wert), 0) + ' Fr. </b>Rang';
        }
        else if (this.point.name == 'Arbeitsplätze&nbsp;pro&nbsp;Kopf') {
          w = Highcharts.numberFormat((this.point.Wert), 2) + '  </b>Rang';
        }
        else {
          w = Highcharts.numberFormat((this.point.Wert * 100), 1) + '% </b>Rang';
        }
        return "" +
          ...
          '<span style="color:' + this.point.color + '">\u25CF</span> ' + this.point.Wohnviertel + ': Wert' + ' <b>' + w + ' <b>' + this.point.y + '</b><br/>' +
          '</div>';
      }
    },
