		...
		chart: {
			events: {
	            load: function (e) {
	                ...
	                fn.addLegendLabelbold(chart, 'Anteil Wohnen an der<br>Gesamtbruttogeschossfläche in %', legendPosition.blockSymbol.title.x, legendPosition.blockChoropleth.title.y[1]);
