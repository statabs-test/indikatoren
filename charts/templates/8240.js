		...
		chart: {
			events: {
				load: function (e) {
					...
					//console.log(this.legend.options)					
					var lp = this.legend.options.legendPosition;

						this.legend.options.x = lp.blockChoropleth.x;
						this.legend.options.y = lp.blockChoropleth.y;
