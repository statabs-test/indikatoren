		...
		chart: {
			events: {
				load: function (e) {
					...
					var maxValueInLegend = 130000;

					//Add manually drawn legend
					fn.addLegendRectangle(chart, 260, 220, 223, 77, '#fbfbfb', 'pieLegend');
					fn.addLegendRectangle(chart, 260, 300, 223, 60, '#fbfbfb');

					fn.addLegendTitle(chart, "Zunahme von 1995 bis 2015 in m²", 265, 220, 'pieLegend');
