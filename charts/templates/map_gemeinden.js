    ...
    return {
        ...
        "tooltip": {
            ...
            "formatter": function (args) {
                //console.log(Highcharts.charts[0].legend.title.text.textStr);
                if (!this.point["CODGEO"]) {
                    //Grenzen, Massstab
                    return '<span style="color:' + this.color + ';">\u25CF </span><span>' + this.series.name + '</span>';
                } else {
                    return '<span style="color:' + this.color + ';">\u25CF</span><span style="font-size: 0.85em;"> ' + this.series.name + ':</span><br/>' +
                        this.point.properties.LIBGEO + ': <b>' + Highcharts.numberFormat((this.point.value), 0) + ' ' + Highcharts.charts[0].legend.title.text.textStr + '</b>';
                }
            }
        },
        "afterSeries": [
