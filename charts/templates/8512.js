		...
		chart: {
			events: {
	            load: function (e) {
	        		...
	        		fn.addLegendTitle(chart, choroplethSeries.name.replace(" ", "<br/>"), 245 + shiftHoriz, 247 + shiftVert);
	                fn.addLegendTitle(chart, pieSizeSeries.name.replace("lfe", "lfe-<br/>"), 385 + shiftHoriz, 247 + shiftVert);
	                ...
	                fn.addLegendLabel(chart, pieSizeCatConfig[1].name, 450 + shiftHoriz, 325 + shiftVert, undefined, false, 'right');
