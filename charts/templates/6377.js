		...
		chart: {
			events: {
	            load: function (e) {
	                ...
	                fn.addLegendLabel(chart, "<tspan fill='rgba(0,0,0,0)'>00</tspan><tspan>" + Highcharts.numberFormat((minValueInLegend),0,","," ") + "</tspan>", 300, 245, 'pieLegendRecalculateOnZoom', false, minValueInLegend);
