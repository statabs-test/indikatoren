		...
		chart: {
			events: {
	            load: function (e) {
	                ...
	                fn.addLegendText(chart,        legendLeft+15, legendTop+35,  Highcharts.numberFormat(legendColumnValues[0], 0,","," "), color(legendColumnValues[0], 0), 'columnLegendHideOnZoom');
	                //fn.addLegendText(chart,        legendLeft+71, legendTop+45,  ',', undefined, 'columnLegendHideOnZoom');
	                fn.addLegendText(chart,        legendLeft+25, legendTop+35,  Highcharts.numberFormat(legendColumnValues[1], 1,","," "), color(legendColumnValues[1], 1), 'columnLegendHideOnZoom');
