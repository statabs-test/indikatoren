		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace("eiz ", "eiz<br/>"), lp.blockChoropleth.title.x, lp.blockChoropleth.title.y[1]);
					/*Adjust  lp.blockChoropleth.title.y[x] according to number of lines:
																								1 line  -> 0
																								2 lines -> 1
																								3 lines -> 2*/
