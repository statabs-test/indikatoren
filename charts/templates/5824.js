	                ...
	                Highcharts.each(chart.series[1].points, function (data) {
	                    ...
	                    var currentPieSeries = 
	                    {
	                        ...
	                        sizeFormatter: function () {
								...
								var minSize = this.chart.chartWidth / 45 * pieSize * zoomFactor;
								var maxSize = this.chart.chartWidth / 11 * pieSize * zoomFactor * data.value / maxNumber; 
	                        ...
	                        tooltip: {
	                            ...
	                            pointFormatter: function () {
	                            	return wohnviertelSeries.properties.LIBGEO +': <b>' +  Highcharts.numberFormat((this.y),2) + '</b><br/>';
	                            }
	                        },
	                        data: [
	                        	{
