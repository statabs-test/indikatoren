		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendTitle(chart, "Anteil Familien- <br/> haushalte (%)", 245 + shiftHoriz, 220 + shiftVert);
					
					fn.addLegendTitle(chart, "Veränderung <br/> gegenüber <br/> 2011 (pp)", 385 + shiftHoriz, 220 + shiftVert);
