		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace("lien", "lien-<br/>"), 245 + shiftHoriz, 220 + shiftVert);
					
					fn.addLegendTitle(chart, pieSizeSeries.name.replace("z ", "z<br/> "), 385 + shiftHoriz, 220 + shiftVert);
