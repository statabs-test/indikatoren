		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace("lte ", "lte<br/>"), 245 + shiftHoriz, 247 + shiftVert);

					fn.addLegendTitle(chart, pieSizeSeries.name.replace(" ", "<br/>")/*"Differenz <br/> 2018 zu 2013 (pp)"*/, 385 + shiftHoriz, 247 + shiftVert);
