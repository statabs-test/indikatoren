		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendTitle(chart, "Anzahl <br/> vermittelte <br/> Wohnungen", 355, 210+50);
					...
					fn.addLegendCircle(chart, 367, 325, 0.5*fn.pieSize(minValueInLegend, extremeValues.maxAbsNumber, maxPieDiameter), '#B00000');
	                fn.addLegendLabel(chart, Highcharts.numberFormat((minValueInLegend),0,","," "), 382, 314);
	                fn.addLegendCircle(chart, 367, 345, 0.5*fn.pieSize(maxValueInLegend, extremeValues.maxAbsNumber, maxPieDiameter), '#B00000');
