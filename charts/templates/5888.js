	            ...
	            load: function (e) {
	              ...
	              //Pie size 
	                ...
	                //Add manually drawn legend
	                 chart.renderer.label(chart.series[0].name, 320, 200)
     				.css({
	                    fontSize: '12px',
	                    fontWeight: 'bold'
	                })
					...
					chart.renderer.label(Highcharts.numberFormat((minBubbleSize),3, ",", " "), 455, 221).attr({
						zIndex: 6,
						class: 'pieLegend', 
					}).add();
					...
					chart.renderer.label(Highcharts.numberFormat((maxBubbleSize),1, ",", " "), 455, 237).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
