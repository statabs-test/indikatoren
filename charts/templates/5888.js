			...
			events: {
	            load: function (e) {
	                ...
	                */
					...
					chart.renderer.label(Highcharts.numberFormat((minValueInLegend),3,","," "), 485, 221).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
				    ...
				    chart.renderer.rect(525, 225, 10, 10, 0).attr({
			            'stroke-width':0,
			            fill: 'grey',
			            zIndex: 6,
			            class: 'pieLegend'
			        }).add();
			        chart.renderer.label('Zunahme', 540, 221).attr({
			        	zIndex: 6,
			        	class: 'pieLegend'
			        }).add();
					chart.renderer.rect(525, 241, 10, 10, 0).attr({
			            'stroke-width':0,
			            fill: 'salmon',
			            zIndex: 6,
			            class: 'pieLegend'
			        }).add();
			        chart.renderer.label('Abnahme', 540, 237).attr({
			        	zIndex: 6,
			        	class: 'pieLegend'
			        }).add();
