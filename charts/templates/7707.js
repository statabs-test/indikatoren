		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, "Anteil Einwohner <br/> über 20 µg/m³ in %", 245, 220); //addLegendTitle: function (chart, text, x, y, cssClass, useHtml)
					fn.addLegendTitle(chart, "Anzahl Einwohner <br/> über 20 µg/m³", 365, 220);
