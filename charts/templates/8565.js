		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace(" in Fr", "<br/> in 1 000 Fr."), legendPosition.blockCloropleth.title.x, legendPosition.blockCloropleth.title.y[1]);
					/*
