		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendLabelbold(chart, 'Zugezogene pro 100 Einwohner', 265, 225, 'pieLegendStayeOnZoom');
					fn.addLegendTitle(chart, 'Anteil aus dem Ausland Zugezogene', 265, 315);
