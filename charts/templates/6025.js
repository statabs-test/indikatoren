		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendSquare(chart, 258, 265, 10, 'red', 'pieLegendHideOnZoom');
					fn.addLegendLabel(chart, 'Schweiz', 270, 260, 'pieLegendHideOnZoom');
					fn.addLegendSquare(chart, 258, 285, 10, 'blue', 'pieLegendHideOnZoom');
					fn.addLegendLabel(chart, 'Ausland', 270, 280, 'pieLegendHideOnZoom');
					fn.addLegendLabelbold(chart, 'Anzahl Zugezogene pro 100 Einwohner', 255, 305, 'pieLegendHideOnZoom');
