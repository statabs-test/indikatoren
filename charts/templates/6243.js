		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendSquare(chart, 878, 341, 10, '#7F5F1A');
					fn.addLegendLabel(chart, 'Zunahme', 893, 334);
					fn.addLegendSquare(chart, 878, 360, 10, '#FABD24');
					fn.addLegendLabel(chart, 'Abnahme', 893, 354);
