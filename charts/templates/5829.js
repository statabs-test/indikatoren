		...
		"series": [
			{
				...
				tooltip: {
					pointFormatter: function(){
						//console.log(this);
						return this.properties.LIBGEO +': <b>' + Highcharts.numberFormat((this.value),5) + '</b><br/>';
					}
				}
			}, 
			{
	                ...
	                Highcharts.each(chart.series[1].points, function (data) {
	                    ...
	                    var currentPieSeries = 
	                    {
	                        ...
	                        tooltip: {
	                            ...
	                            pointFormatter: function () {
	                            	return wohnviertelSeries.properties.LIBGEO +': <b>' + Highcharts.numberFormat((this.v),5) + '</b><br/>';
	                            }
	                        },
	                        data: [
	                        	{
