	            ...
	            load: function (e) {
	             ...
	             //Pie size 
	                ...
	                */
	                ...
	                chart.renderer.label(chart.series[1].name, 286, 240)
     				.css({
	                    fontSize: '12px',
	                    fontWeight: 'bold'
	                })
					...
					chart.renderer.label(Highcharts.numberFormat((minBubbleSize),3, ",", " "), 430, 265).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
					...
					chart.renderer.label(Highcharts.numberFormat((maxBubbleSize),1, ",", " "), 430, 290).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
