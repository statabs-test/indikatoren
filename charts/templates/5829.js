			...
			events: {
	            load: function (e) {
	                ...
	                */
					...
					chart.renderer.label(Highcharts.numberFormat((minValueInLegend),3,","," "), 430, 265).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
					...
					chart.renderer.label(Highcharts.numberFormat((maxValueInLegend),2,"."," "), 430, 290).attr({
						zIndex: 6,
						class: 'pieLegend'
					}).add();
