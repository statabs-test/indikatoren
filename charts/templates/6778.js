		...
		chart: {
			events: {
	            load: function (e) {
	                ...
	                fn.addLegendRectangle(chart, 250, 210, 100, 160, '#ffffff', 'pieLegend');
	                fn.addLegendRectangle(chart, 355, 210, 125, 160, '#ffffff', 'pieLegend');
	                fn.addLegendLabelbold(chart,"Ausländeranteil <br/> in %", 253, 215);
	                fn.addLegendLabelbold(chart, 'Staatsangehörigkeit', 355, 215);
