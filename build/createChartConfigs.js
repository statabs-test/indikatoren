...
console.log('Loading PLZ shape...');
var geojson_PLZ_EPSG_2056 = JSON.parse(fs.readFileSync('geojson/PLZ_EPSG_2056.json'));
console.log('Loading GemeindenBSBL shape...');
var geojson_GemeindenBSBL_EPSG_2056 = JSON.parse(fs.readFileSync('geojson/GemeindenBSBL_EPSG_2056.json'));
...
function saveChartConfig(indikator, view, console){
    ...
    var scalebarDataEPSG2056_5km = Highcharts.geojson(geojson_scalebarEPSG2056_5km, 'mapline');
