...
var geojson_scalebarGundeldingen = JSON.parse(fs.readFileSync('geojson/scalebar_Gundeldingen.json'));
console.log('Loading Gundeldingen...-------------------------------------------------------');
