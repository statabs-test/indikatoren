var indikatorensetData = [
	...
	},
	{
		...
		"stufe4": "",
		"stufe5": "",
		"lesehilfe": "Der Jugendquotient ist von 2008 bis 2011 leicht zurückgegangen. Dies liegt daran, das die Zahl der Jugendlichen deutlich weniger stark gestiegen ist als jene der Personen im Erwerbsalter. Seit 2013 steigt derJugendquotient wieder.",
	...
	},
	{
		...
		"stufe4": "",
		"stufe5": "",
		"lesehilfe": "Die Lebenserwartung bei Geburt für Frauen liegt im gesamten Beobachtungszeitraum über derjenigen der Männer. Die Werte für  2016 liegen bei 84,4 Jahre (Frauen) und 80,4 Jahre (Männer).",
	...
	},
	{
		...
		"stufe4": "",
		"stufe5": "",
		"lesehilfe": "Die Verkehrsunfallstatistik 2016 zeichnet sich durch eine leichte Erhöhung der Unfallzahlen aus, die sich in den meisten Unfallkategorien niederschlägt. Mit 871 durch die Polizei rapportierte Unfälle nahm deren Gesamtzahl im Vergleich zum Vorjahr (+41) zu. 389 Personen wurden als Leichtverletzte (Veränderung gegenüber 2015: +16) erfasst. Die Zahl der Schwerverletzten blieb mit 97 im Vergleich mit dem Vorjahr unverändert. Vier Personen (+1) starben im vergangenen Jahr an den Folgen eines Verkehrsunfalls. Alle diese Unfalltoten waren 75 Jahre alt oder älter.",
		"erlaeuterungen": "",
		"template": "line001",
	...
	},
	{
		...
		"erlaeuterungen": "Lärmbelastete Einwohner sind Personen, welche an ihrem Wohnort einer Lärmbelastung über dem Immissionsgrenzwert gemäss Lärmschutzverordnung (LSV) ausgesetzt sind. Die in der LSV festgehaltenen Immissionsgrenzwerte drücken das Mass an Lärmbelastung aus, das zirka 75% der Bevölkerung erträgt, ohne sich erheblich gestört zu fühlen. Wohngebiete sind gemäss Lärmempfindlichkeitsstufenplan den Stufen II (Wohnzonen) und III (Wohn-/Gewerbezonen) mit unterschiedlichen Immissionsgrenzwerten zugeteilt: ES II: 60 dB(A) Tag, 50 dB(A) Nacht, ES III: 65 dB(A) Tag, 55 dB(A) Nacht; dB(A) ist die übliche Masseinheit zur Messung von Lärmstärke.<br><br><br><br>Die angegebenen Werte beruhen auf Modellierungen. Die Lärmimmission an den Gebäuden werden in einem 3D-Oberflächenmodell (Gelände, Gebäude, Hindernisse) auf Basis des Emissionskatasters für Strassenverkehrslärm berechnet. Sobald ein Teil eines Gebäudes, z. B. eine Fassade oder die oberen Geschosse, welche nicht durch eine Lärmschutzwand geschützt werden, von Grenzwertüberschreitungen (gemäss LSV) betroffen sind, werden sämtliche Bewohner des Gebäudes als lärmbelastete Personen gezählt. Die Ausrichtung der einzelnen Wohnungen fliesst nicht in die Beurteilung ein. Weiter werden lärmempfindliche Räume in Betrieben nicht berücksichtigt.",
		"template": "template001",
	...
	},
	{
		...
		"stufe4": "",
		"stufe5": "",
		"lesehilfe": "Der Anteil der Life Sciences Industrie an der nominalen Gesamtwertschöpfung des Kantons Basel-Stadt liegt 2016 bei 36%. Im Jahr 2000 lag er noch bei 24%. Den grössten Rückgang des Wertschöpfungsanteils verzeichnete die Branche der Finanz- und Versicherungsdienstleitungen.",
	...
	},
	{
		...
		"stufe4": "",
		"stufe5": "",
		"lesehilfe": "Der ökologische Fussabdruck der Schweiz mass 2013 5,3 globale Hektaren pro Kopf. Das Bruttoinlandprodukt pro Kopf des Kantons Basel-Stadt ist zwischen den 90er-Jahren und 2013 stark gestiegen.",
