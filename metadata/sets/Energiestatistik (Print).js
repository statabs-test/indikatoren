var indikatorensetData = [
	...
	},
	{
		...
		"erlaeuterungen": "Dieser Indikator zeigt den Bruttoenergieverbrauch der Erneuerbaren, die im Kanton gewonnen wurden. Der Import von Erneuerbaren in den Kanton, insbesondere den ausserkantonalen Bezug von Elektrizität, bleibt folglich unberücksichtigt.",
		"quellenangabe": [
			"Statistisches Amt Basel-Stadt, Energiestatistik"
		],
		"externalLinks": [],
	...
	},
	{
		...
		"lesehilfe": "Die Menge CO<sub>2 </sub> pro Einwohner hat zwischen 2010 und 2020 von 4,7 Tonnen auf 3,1 Tonnen im Jahr abgenommen. Der Rückgang geht aufHeizöl (-54%), Treibstoffe (-34%), Erdgas (-23%), Industrie- und Sonderabfall sowie den nicht erneuerbaren Teil von Kehricht (-2%) zurück. 2020 sind die Emissionen aus Erdgas mit 41% für den grössten Teil aller CO<sub>2 </sub>-Emission verantwortlich.",
